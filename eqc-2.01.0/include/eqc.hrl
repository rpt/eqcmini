-import(eqc_gen,
	...
	resize/2,
   	parameter/1, parameter/2, with_parameter/3, with_parameters/2,
        ...
        oneof/1, frequency/1,
        non_empty/1,
        elements/1, growingelements/1, list/1, shrink_list/1, shrink_genlist/1, vector/2, % map/2,
	...
	utf8/0, binary/0, binary/1, bitstring/0, bitstring/1,
...
-import(eqc,[collect/2, collect/3,
             ...
             measure/3,
             %distribution/0,
             with_title/1, only_top/1, only_top/2
